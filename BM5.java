...
public class BM5
{
	public static void main(String[] args) throws Exception
	{
		...
		if(actor.equals("2")||actor.equals("1"))
		{
			...
			if(actor.equals("2"))
			{
				...
				System.out.println("(8)搜尋[照書名(9)修改(10)刪除(11)重整排列寫回檔案[照編號(12)設定顯示欄位");
				System.out.println("=================================================================================");
				System.out.println("(13)書籍相關資訊<<標星等,閱讀進度,書籍位置>>(14)分類搜尋:");
			}
		...
		else if(actor.equals("1"))
		{
			...
			System.out.print("(8)serch(9)amend(10)delete(14)分類搜尋(15)查看書籍相關資訊:");
		}	
	...
	else if(respond.equals("9"))
	{
		...
		if(flag == 1) System.out.println("找不到相關資料~~請再次輸入!!!");
		
		if(flag == 0)
		{
			System.out.print("請輸入欲修改的欄位(1)書名(2)作者(3)出版社(4)編號(5)類別(6)年分:");
			String s1new = keyin.next();
			if(s1new.equals("1"))
			{
				System.out.print("input update data:");
				String up = keyin.next();
				Array1[record] = up;
				System.out.print("有要修改其他欄嗎?(y/n)");
				String nn = keyin.next();
...
else if(respond.equals("13"))
{
		...
		while(inputStream.hasNext())
		{	
			String c1 = inputStream.next(); array1.add(c1); System.out.print(c1+" ");
			String c2 = inputStream.next(); array2.add(c2);	System.out.print(c2+" ");
			String c3 = inputStream.next(); array3.add(c3);	System.out.print(c3+" ");
			String c4 = inputStream.next(); array4.add(c4);	System.out.print(c4+" ");
			String c5 = inputStream.next(); array5.add(c5);	System.out.print(c5+" ");
			String c6 = inputStream.next(); array6.add(c6);	System.out.print(c6);
			System.out.println();
		}
		int size = array1.size();
		//從.txt檔抓資料存入陣列中並顯示
		...
		String[] Array2 = (String[]) array2.toArray(new String[0]);
		String[] Array3 = (String[]) array3.toArray(new String[0]);
		String[] Array4 = (String[]) array4.toArray(new String[0]);//書籍編號
		String[] Array5 = (String[]) array5.toArray(new String[0]);
		String[] Array6 = (String[]) array6.toArray(new String[0]);
		//Arraylist轉一般陣列
		
		System.out.print("請選擇欲編輯書籍的編號:");
		String number = keyin.next();
		int o=0;
		...
		System.out.print("(1)一顆星:還可以(2)兩顆星:推推(3)三顆星:買啦:");
		String stars = keyin.next();
		System.out.print("請輸入進度:未閱讀||閱讀中||閱讀完畢:");
		String sche = keyin.next();
		System.out.print("書本在哪兒?");
		String where = keyin.next();
		...
		try{ 
		FileWriter fw=new FileWriter("moreInformation.txt");//true false 沒有差別
...
else if(respond.equals("14"))
{
	while(true)
	{
	System.out.print("(1)電腦科學(2)大眾心理學(3)文學(4)圖文(5)數理(6)遊戲(7)漫畫:");
	...
	Scanner inputStream = null;
		...
		String[] Array3 = (String[]) array3.toArray(new String[0]);
		String[] Array4 = (String[]) array4.toArray(new String[0]);//書籍編號
		String[] Array5 = (String[]) array5.toArray(new String[0]);//類別
		String[] Array6 = (String[]) array6.toArray(new String[0]);	
		if(choice.equals("1"))
		{
			for(int i=0;i<size;i++)
	...
	{
		System.out.print("Plese enter 1-15:");
